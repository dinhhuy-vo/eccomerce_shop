...
<template>
    <UserLayouts>
        <section class="text-gray-600 body-font relative">
            <div
                class="container px-5 py-8 mx-auto flex sm:flex-nowrap flex-wrap"
            >
                ...
                >
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <button
                            v-else
                            type="submit"
                            class="text-white w-full bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded text-lg"
                        >
                            Add address to continue
                        </button>
                    </form>
                    <p class="text-xs text-gray-500 mt-3">Continue</p>
                </div>
            </div>
        </section>
    </UserLayouts>
